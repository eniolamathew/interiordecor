...
const (
	EmailService_SendPasswordResetEmail_FullMethodName = "/mail.EmailService/SendPasswordResetEmail"
)
...
type EmailServiceClient interface {
	SendPasswordResetEmail(ctx context.Context, in *SendPasswordResetRequest, opts ...grpc.CallOption) (*SendEmailResponse, error)
}
...
func (c *emailServiceClient) SendPasswordResetEmail(ctx context.Context, in *SendPasswordResetRequest, opts ...grpc.CallOption) (*SendEmailResponse, error) {
...
type EmailServiceServer interface {
	SendPasswordResetEmail(context.Context, *SendPasswordResetRequest) (*SendEmailResponse, error)
...
func (UnimplementedEmailServiceServer) SendPasswordResetEmail(context.Context, *SendPasswordResetRequest) (*SendEmailResponse, error) {
...
func _EmailService_SendPasswordResetEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).SendPasswordResetEmail(ctx, req.(*SendPasswordResetRequest))
	}
